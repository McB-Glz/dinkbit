module.exports = function(grunt) {
  ...
  var baseJsFileList = [
    ...
    'resources/bower_components/isotope/dist/isotope.pkgd.min.js',
    ...
    'resources/assets/js/chickendinner.js',
    'resources/assets/js/jquery.pin.min.js',
    'resources/assets/js/zebra_pin.js',
  ...
  grunt.initConfig({
    ...
    uglify: {
      ...
      mosaic:{
        files:{
          'public/assets/js/mosaic.min.js': [
            'resources/assets/js/mosaic.js'
          ],
        }
      }
    },
